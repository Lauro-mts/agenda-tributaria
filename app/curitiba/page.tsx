...
const eventoCuritiba = {
  badge: 'AGENDA TRIBUTÁRIA 2026',
  title: <>Principais Mudanças e Impactos<br />Tributários e Tecnológicos<br />no Contexto Empresarial</>,
  subtitle: 'Para empresas e acionistas | Evento presencial com especialistas referência no tema.',
  data: '14 de Abril',
  local: <>Espaço Dante Millarch<br/>Curitiba/PR</>,
  horario: '8h às 12h',
  heroSrc: '/herocuritiba.png',
  heroAlt: 'Especialistas - Agenda Tributária 2026 Curitiba',
}
    ...
    <>
      ...
      >
        <div style={{ width: '100%', maxWidth: '600px' }}>
          ...
          <LandingSection event={eventoCuritiba}>
            {section === 'landing' ? (
              <div
              ...
              >
                ...
                <p style={{ fontSize: '14px', color: 'var(--text-muted)', lineHeight: '1.7', marginBottom: '28px', maxWidth: '400px' }}>
                  Participe de um encontro sobre as principais mudanças tributárias e tecnológicas que impactam sua empresa em 2026.
                </p>
              ...
              <FormSection
                ...
                onToast={showToast}
                evento="Curitiba"
                apiUrl="/api/inscricao-curitiba"
              />
            )}
          </LandingSection>

          <div style={{ marginTop: '24px', display: 'flex', justifyContent: 'center' }}>
            <img src="/tzcoinov.png" alt="Logo" style={{ height: '64px', opacity: 1, filter: 'brightness(1.3)' }} />
          </div>
